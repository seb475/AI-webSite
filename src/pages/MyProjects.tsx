                ...
                {loading ? (
                    ...
                    <div className="py-10 min-h-[80vh]">
                        <div className="flex items-center justify-between mb-12">
                         ...
                         to-indigo-600 hover:opacity-90 active:scale-95 trasition-all">
                        ...
                        <div className='flex flex-wrap gap-3.5'>
                            ...
                            transition-all duration-300'>
                               ...
                               overflow-hidden border-b border-gray-800'>
                                ...
                                to-transparent trasition-colors'>
                                    ...
                                    line-clamp-2">{project.initial_prompt}</p>
                                        ...
                                        <div onClick={(e) => e.stopPropagation()}
                                            className='flex justify-end-between items-center mt-6'>
                                        ...
                                        <div onClick={e => e.stopPropagation()} >
                                            <TrashIcon className='absolute top-3 right-3 scale-0 group-hover:scale-100 bg-white p-1.5
                                       size-7rounded text-red-500 text-xl cursor-pointer transition-all' onClick={() =>deleteProject(project.id)} />
                                        </div>
                                    </div>
                                </div>
                            ))}
